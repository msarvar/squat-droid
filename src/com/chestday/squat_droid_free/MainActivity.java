...
import com.chestday.squat_droid_free.squat.tracking.SquatPipelineListener;
import com.chestday.squat_droid_free.squat.utils.MatManager;
import com.chestday.squat_droid_free.squat.utils.Pair;
import com.chestday.squat_droid_free.squat.utils.android.PortraitCameraView;
import com.chestday.squat_droid_free.squat.utils.android.VideoBridge;
import com.chestday.squat_droid_free.squat.utils.android.VideoBridge.VideoBridgeReadyCallback;
...
public class MainActivity extends ActionBarActivity {
	...
	private void start() {
		// Set the default ad to be clickable
		ImageView adDefault = (ImageView) findViewById(R.id.adDefaultImage);
		adDefault.setOnClickListener(new View.OnClickListener(){
		    public void onClick(View v){
		        Intent intent = new Intent();
		        intent.setAction(Intent.ACTION_VIEW);
		        intent.addCategory(Intent.CATEGORY_BROWSABLE);
		        intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.chestday.squat_droid"));
